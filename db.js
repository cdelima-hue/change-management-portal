...
async function seedInitialDataPostgres() {
  // Forçar atualização/inserção do utilizador Admin Global
  await pool.query(`
    INSERT INTO users (username, password_hash, nombre, role, pais, business_services)
    VALUES ('admin', '$2a$10$wTf/8CInB74o6yV.gT1.5eJzX/vQZ82N6A9JgK3oK9N9/7kY2bU2a', 'Claudio Lima', 'Admin Global', NULL, '{}')
    ON CONFLICT (username) 
    DO UPDATE SET role = 'Admin Global', nombre = 'Claudio Lima';
  `);
